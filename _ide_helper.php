 ...
 * Generated for Laravel 5.6.22 on 2018-05-21 15:08:36.
 *
...
namespace Watson\BootstrapForm\Facades {
    ...
    class BootstrapForm {
        ...
        {
            return \Watson\BootstrapForm\BootstrapForm::time($name, $label, $value, $options);
        }
         ...
         * @static
         */
        public static function addonButton($label, $options = array())
        {
            return \Watson\BootstrapForm\BootstrapForm::addonButton($label, $options);
        }
         ...
         * @static
         */
        public static function addonText($text, $options = array())
        {
            return \Watson\BootstrapForm\BootstrapForm::addonText($text, $options);
        }
         ...
         * @static
         */
        public static function addonIcon($icon, $options = array())
        {
            return \Watson\BootstrapForm\BootstrapForm::addonIcon($icon, $options);
        }
        ...
        {
            return \Watson\BootstrapForm\BootstrapForm::getIconPrefix();
        }
        ...
        {
            return \Watson\BootstrapForm\BootstrapForm::getErrorClass();
        }
        ...
        public static function macro($name, $macro)
        {
            \Watson\BootstrapForm\BootstrapForm::macro($name, $macro);
        }
        ...
        public static function mixin($mixin)
        {
            \Watson\BootstrapForm\BootstrapForm::mixin($mixin);
        }
        ...
        public static function hasMacro($name)
        {
            return \Watson\BootstrapForm\BootstrapForm::hasMacro($name);
        }
